...
**Why this rule exists**: example-npd Forms PR #2 failed review three times because auth checks were added incrementally — edit was hardened but submit/signoff still allowed unmapped users. Centralized policy + regression tests prevent piecemeal gaps.

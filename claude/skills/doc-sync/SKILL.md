...
The runnable collector lives in your-framework and is the first command to run from the target project repo:

```bash
bash ~/ghq/github.com/your-org/your-framework/scripts/doc-sync.sh --write-report
```
...
```bash
bash ~/ghq/github.com/your-org/your-framework/scripts/doc-sync.sh --apply-marker
git add docs/
```

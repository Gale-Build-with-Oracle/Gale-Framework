...
<!-- stack, testing surface (Docker-only for Acme), ports, env quirks — facts only -->
...
codex loads it from the FLEET-DOCTRINE block in ~/.codex/AGENTS.md (rendered from your-framework claude/doctrine/{core,codex}.md; codex reads AGENTS.md, and has no standalone instructions file).

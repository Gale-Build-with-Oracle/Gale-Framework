...
<!-- stack, testing surface (e.g. Docker-only), ports, env quirks — facts only -->
...
codex loads it from the FLEET-DOCTRINE block in ~/.codex/AGENTS.md (rendered from Gale-Framework claude/doctrine/{core,codex}.md; codex reads AGENTS.md, and has no standalone instructions file).
